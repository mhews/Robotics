...
while(input != 'b'):
        input = get_char()
        if input == 'l': #body right
                x.setTarget(0,bodyval-1000)
		#bodyval = bodyval - 500
        if input == 'j': #body left
                x.setTarget(0,bodyval+1000)
		#bodyval = bodyval + 500
	if input == 'k': #body center
		bodyval = 6000
		x.setTarget(0,bodyval)
	if input == 'p': #head right
		x.setTarget(3,headval-1000)
		#headval = headval-500
	if input == 'i': #head left
		x.setTarget(3,headval+1000)
		#headval = headval-500
	if input == 'n': #head up
		x.setTarget(4,headudval+1000)
		#headudval = headudval+500
	if input == 'm': #head down
		x.setTarget(4,headudval-1000)
		#headudval = headudval-500
	if input == 's':#backward
		if speed == 7200:
	...
	if input == 'd':#left
		x.setTarget(2,5000)
	if input == 'o': #head center
		headval = 6000
		headudval = 6000
		x.setTarget(3,headval)
		x.setTarget(4,headudval)
	if input == 'b': #end reset everything
		x.setTarget(0,6000)
		x.setTarget(3,6000)
		x.setTarget(4,6000)
		x.setTarget(1,0)
